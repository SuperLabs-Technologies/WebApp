...
namespace WebApp
{
    public struct JsonObjectBuilder : IDisposable
    {
        ...
        public JsonObjectBuilder Put(string key, JSONReader value)
        {
            EnsureState();
            writer.WriteCommaIf(startOffset);
            writer.WriteKey(key);
        ...
        public JsonObjectBuilder PutArray(string key, IEnumerable<JSONReader> elements)
        ...
        public JsonObjectBuilder PutObject(string key, IEnumerable<KeyValuePair<string, JSONReader>> members)
            => PutObjectOf(key, members, (objectBuilder, member) => objectBuilder.Put(member.Key, member.Value));
        ...
        public JsonObjectBuilder PutIf(bool condition, string key, JSONReader value) => condition ? Put(key, value) : this;
