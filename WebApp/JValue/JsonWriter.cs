...
namespace WebApp
{
    internal sealed class JsonWriter : IDisposable
    {
        ...
        public void WriteNull() => underlyingWriter.Write(JSONReader.NullLiteral);
        public void Write(bool value) => underlyingWriter.Write(value ? JSONReader.TrueLiteral : JSONReader.FalseLiteral);
        ...
        public void Write(JSONReader value) => value.WriteTo(underlyingWriter);
    ...
    internal static class JsonTextWriterExtensions
    {
        ...
        public static void WriteEscapedString(this TextWriter writer, string value)
        {
            if (value != null)
            {
                ...
                writer.Write(JSONReader.NullLiteral);
        }
